...
ScrollReveal().reveal(".about__row:nth-child(3) .about__img img, .about__row:nth-child(5) .about__img img", {
    ...scrollRevealOption,
    origin: "left",
});

ScrollReveal().reveal(".about__row:nth-child(4) .about__img img", {
    ...scrollRevealOption,
    origin: "right",
});
